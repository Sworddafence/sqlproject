...
public class GameRental {
   ...
   public static void main (String[] args) {
      ...
      //  }
         switch(Integer.parseInt(args[3])){
            case 1: LogIn(esql, args[4], args[5]);
            case 2: CreateUser(esql, args[4], args[5], args[6]);
            case 3: viewProfile(esql, args[4]);
            case 4: updateProfile(esql, args[4], Integer.parseInt(args[5]), Integer.parseInt(args[6]), args[7]);
            case 5: viewCatalog(esql, Integer.parseInt(args[4]), Integer.parseInt(args[5]), args[6]);
         }        
  ...
  /*
    * Creates a new user
    **/
   public static void CreateUser(GameRental esql, String username, String pwd, String phonenum){
    ...
    **/
   public static String LogIn(GameRental esql, String username, String pwd){
      print("LOGGINGIN");
...
// Rest of the functions definition go in here
   ...
   public static void viewProfile(GameRental esql, String username) {
      ...
      String input = "select favgames from users where users.login = \'" + username + "\'";
      
      List<List<String>> t = easyRet(input, esql);
      for (String element : t.get(0)) {
         System.out.print(element);
      }
      input = "select phonenum from users where users.login = \'" + username + "\'";
      System.out.print("|" + easyRet(input, esql).get(0).get(0));
      input = "select numoverduegames from users where users.login = \'" + username + "\'";
      System.out.print("|"+ easyRet(input, esql).get(0).get(0));
   }
   public static void updateProfile(GameRental esql, String username, int choice1, int choice2, String change) {
      ...
      switch(choice1){
         case 1:
            ...
            switch(choice2){
               case 1:
                  String input1 = "select favgames from users where users.login = \'" + username + "\'"; 
                  ...
                  input1 = "UPDATE users SET favgames = CONCAT(favgames, \'" + commaexist + gameName1 + "\') WHERE login = \'" + username + "\'";
               ...
               case 2:
                  ...
                  input = "UPDATE users SET favgames = \'"+ newfav +"\' WHERE login = \'"+ username + "\'";
            ...
            break;
         case 2:   
            String newpwd = change;
            callUpdate("UPDATE users SET password = \'" + newpwd + "\' WHERE login = \'" + username + "\';", esql);
   ...
   public static void viewCatalog(GameRental esql, int choice1, int choice2, String genre) {
      switch(choice1){
         case 1:
